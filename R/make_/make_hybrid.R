...
pure_V_T = pure_pairs[,lag(depVar,1), by = "rs_id"][[depVar]]
pure_t_month = pure_pairs[["emonths"]]
pure_T_month = pure_pairs[,lag("emonths",1), by = "rs_id"][["emonths"]]
# changed
changed_V_t = changed_pairs[[depVar]]
changed_V_T = changed_pairs[,lag(depVar,1), by = "rs_id"][[depVar]]
changed_t_month = changed_pairs[["emonths"]]
changed_T_month = changed_pairs[,lag("emonths",1), by = "rs_id"][["emonths"]]
